    ...
    <section className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.sectionBtn}>
          <a href="mailto: pedromgoulartt@gmail.com" className={styles.contactBtn}>Entre em contato</a>
          <a href="https://api.whatsapp.com/send?phone=5521998552748" className={styles.contactBtn2}>WhatsApp</a>
        </div>
      </div>
